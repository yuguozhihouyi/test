...
<style type="text/css">
  ...
  <body>
    <h3>添加2级分类</h3>
    <h1></h1>
    <form action="<c:url value='/admin/adminCategoryAction_addTwoLevel'/>" method="post" onsubmit="return checkForm()">
...
<c:forEach items="${parents }" var="parent">
	<option value="${parent.cid }" <c:if test="${pid eq parent.cid }">selected='selected'</c:if> >${parent.cname }</option>
    	...
    	分类描述：<textarea rows="5" cols="50" name="detail" id="detail"></textarea><br/>
