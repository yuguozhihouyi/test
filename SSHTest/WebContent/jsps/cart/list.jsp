...
function deleteBatch() {
	...
	location = "<c:url value='/cart/cartItemAction_delete?method=delete&cartItemIds='/>" + cartItemIds;
}
...
<c:forEach items="${cartItemList}" var="item">
	<tr align="center">
		...
		<td align="left" width="70px">
			<a class="linkImage" href="<c:url value='/book/bookAction_load?method=load&bid=${item.book.bid }'/>"><img border="0" width="54" align="top" src="<c:url value='/${item.book.image_b }'/>"/></a>
		</td>
		<td align="left" width="400px">
		    <a href="<c:url value='/book/bookAction_load?method=load&bid=${item.book.bid }'/>"><span>${item.book.bname }</span></a>
		</td>
		...
		<td>
			<a href="<c:url value='/cart/cartItemAction_delete?method=delete&cartItemIds=${item.cartItemId }'/>">删除</a>
		</td>
	</tr>
</c:forEach>
	...
	<form id="form1" action="<c:url value='/cart/cartItemAction_loadCartItems'/>" method="post">
